...
public class Botones_Fijos {
    ...
    //BOTONES DE RADIO ---------------------------------------------------------------------------------------------
    private static JToggleButton radioBotones(){
    ...
    //OBTENER
    private static void Obtener(JToggleButton A){
    ...
    private static void Acciones(JToggleButton A){
    ...
    private static void Eventos(JToggleButton A){
    ...
    private static JToggleButton botonGrupo(){
    ...
    private static void ObtenerGrupo(JToggleButton A){
