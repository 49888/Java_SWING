...
public class Casillas_de_Verificacion {
    ...
    private static JCheckBox casillaVerificacion(){
        ...
        //Establecer Mensaje emergente
            A.setToolTipText("Esto es una Casilla de verificacion");
        ...
        //Establecer Icono (Quita la casilla para marcar)
            ImageIcon icono = new ImageIcon("Iconos\\24x24\\reproductor.png");
    ...
    //OBTENER
    private static void Obtener(JCheckBox A){
    ...
    private static void Acciones(JCheckBox A){
    ...
    private static void Eventos(JCheckBox A){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //Cambiar Iconos 
                    if(A.isSelected()){
                        ...
                        A.setIcon(new ImageIcon("Iconos\\16x16\\OK1.png"));
                    }
                    else{

                        A.setIcon(new ImageIcon("Iconos\\16x16\\NoOK1.png"));
                    }
                //*/
            }   
    ...
    private static JCheckBox botonGrupo(){
    ...
    private static void ObtenerGrupo(JCheckBox A){
